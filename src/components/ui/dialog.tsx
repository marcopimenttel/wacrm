...
function DialogContent({
  ...
  /** Largura do modal. Use `form` para formulários com muitos campos. */
  size = "sm",
  ...props
}: DialogPrimitive.Popup.Props & {
  showCloseButton?: boolean
  size?: "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "4xl" | "5xl" | "form"
}) {
  const sizeClass = {
    sm: "sm:max-w-sm",
    md: "sm:max-w-md",
    ...
    "4xl": "sm:max-w-4xl",
    "5xl": "sm:max-w-5xl",
    // Formulários densos (liderança, apoiador, etc.)
    form: "sm:max-w-3xl md:max-w-4xl lg:max-w-5xl",
  }[size]
