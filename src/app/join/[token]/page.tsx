...
export default function JoinPage() {
  ...
  const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
    not_found: {
      title: t('failNotFoundTitle'),
      body: t('failNotFoundBody'),
    },
    used: {
      title: t('failUsedTitle'),
      body: t('failUsedBody'),
    },
    expired: {
      title: t('failExpiredTitle'),
      body: t('failExpiredBody'),
    },
    server_error: {
  ...
  const inviteHeader = (
    <CardHeader className="items-center text-center">
      ...
      <CardTitle className="text-xl text-foreground">
        {t('invitedTo', { accountName: peek.account_name })}
      </CardTitle>
      <CardDescription className="text-muted-foreground">
        {t('joinAs', {
          role: ROLE_LABEL[peek.role],
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              {t('acceptHint', { accountName: peek.account_name })}
            </p>
          </CardContent>
        </Card>
